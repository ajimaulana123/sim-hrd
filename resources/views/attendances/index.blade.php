                ...
                <div class="flex flex-wrap items-end gap-4">
                    ...
                    <div class="w-full sm:w-48">
                        ...
                        <x-text-input id="search" name="search" type="text" class="mt-1 block w-full" 
                            :value="request('search')" placeholder="Nama atau ID Karyawan"/>
                    </div>
